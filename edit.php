...
$username = "root";
$password = "";
$databasename = "seminar"; // Ganti menjadi seminar sesuai dengan nama database yang benar
...
if (isset($_GET['id'])) {
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        $email = $_POST['email'];
        $name = $_POST['name']; // Ganti 'nama' dengan 'name'
        $institution = $_POST['institution']; // Ganti 'institusi' dengan 'institution'
